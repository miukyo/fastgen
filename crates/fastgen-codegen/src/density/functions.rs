...
const DATAPACK_BASE: &str = "reference/SteelMC/steel-utils/build_assets/builtin_datapacks/minecraft/worldgen";
...
fn generate_noise_settings(dimension: &str, prefix: &str) -> TokenStream {
    ...
    let (
        ...
        (
            ...
            quote! {
                {
                    static BLOCK_STATES: std::sync::OnceLock<Box<[crate::block::BlockStateId]>> =
                        std::sync::OnceLock::new();
                    BLOCK_STATES.get_or_init(|| {
                        Box::from([
                            #(crate::steel_registry::vanilla_blocks::#block_state_idents.default_state()),*
                        ])
                    })
                }
            },
        ...
        let empty_func = quote! {
            ...
            fn apply_surface_rule_impl(
                _ctx: &mut crate::surface::SurfaceRuleContext<'_>,
            ) -> Option<crate::block::BlockStateId> {
                None
            }
        };
        (
    ...
    quote! {
        ...
        impl #settings_struct {
            ...
            #[inline]
            pub fn default_block_id() -> crate::block::BlockStateId {
                crate::steel_registry::REGISTRY.blocks.get_default_state_id(&crate::steel_registry::vanilla_blocks::#default_block_ident)
            }

            /// Get the default fluid state ID for this dimension.
            #[inline]
            pub fn default_fluid_id() -> crate::block::BlockStateId {
                crate::steel_registry::REGISTRY.blocks.get_default_state_id(&crate::steel_registry::vanilla_blocks::#default_fluid_ident)
            }
        }

        impl crate::density::NoiseSettings for #settings_struct {
            ...
            #[inline]
            fn default_block_id() -> crate::block::BlockStateId {
                #settings_struct::default_block_id()
            }

            #[inline]
            fn default_fluid_id() -> crate::block::BlockStateId {
        ...
        impl crate::density::ColumnCache for #cache_struct {
        ...
        impl crate::density::DimensionNoises for #noises_struct {
            type ColumnCache = #cache_struct;
            type Settings = #settings_struct;

            fn create(
                seed: u64,
                splitter: &crate::random::RandomSplitter,
                params: &rustc_hash::FxHashMap<String, crate::density::NoiseParameters>,
            ) -> Self {
            ...
            fn fill_cell_corner_densities_4x(
                ...
                ys: crate::simd::f64x4,
                z: i32,
                blended_noise_values: crate::simd::f64x4,
                out: &mut [f64],
            ) {
            ...
            fn surface_rule_block_states() -> &'static [crate::block::BlockStateId] {
                #surface_block_states_tokens
            }
            ...
            fn try_apply_surface_rule(
                ctx: &mut crate::surface::SurfaceRuleContext<'_>,
            ) -> Option<crate::block::BlockStateId> {
...
pub(crate) fn build() -> DensityFunctionFiles {
    ...
    let overworld = quote! {
        use crate::steel_registry::RegistryExt;
        use crate::steel_registry::blocks::block_state_ext::BlockStateExt;
