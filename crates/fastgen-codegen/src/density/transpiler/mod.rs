...
pub fn transpile(input: &TranspilerInput) -> TokenStream {
    ...
    quote! {
        use crate::simd::{f64x4, Mask4, Select, SimdFloat, SimdPartialOrd};

        use crate::density::spline_eval;
        use crate::density::RarityValueMapper;
        use crate::math::{clamp, map_clamped};
        use crate::noise::NormalNoise;
        use crate::random::{PositionalRandom, RandomSplitter};
